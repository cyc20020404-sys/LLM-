...
KEYWORDS = {
    "吐槽抱怨": [
        "吐槽", "救命", "会谢", "社死", "尴尬", "烦死", "崩溃", "崩溃", "心梗",
        "真的会谢", "瞳孔地震", "咱就是说", "裂开", "窒息", "破防", "无语",
        "笑死", "气死", "委屈", "扎心", "好气", "裂开", "心凉",
    ],
    "分享喜悦": [
        "开心", "感动", "幸福", "圆满", "进步", "可爱", "甜", "暖", "圆满",
        "笑出声", "太懂", "绝了", "绝了", "好类", "感动落泪", "超开心",
        "圆满", "赢了", "抢到", "中奖", "成功", "闪闪发光",
    ],
    "恋爱情感": [
...
if __name__ == "__main__":
    ...
    in_path = os.path.join(_root, "data_conv", "gold_data_2000.jsonl")
